                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <form action="<?=site_url('stock/process')?>" method="post">
                            ...
                            <div class="form-group">
                                <label>Info *</label>
                                <input type="text" name="detail" class="form-control" placeholder="Rusak / Cacat / Hilang / dll." required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" name ="out_add" class="btn btn-flat btn-success">
