    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-tittle">Tambah Stok Barang</h3>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <form action="<?=site_url('stock/process')?>" method="post">
                            ...
                            <div class="form-group">
                                <label>Detail *</label>
                                <input type="text" name="detail" class="form-control" placeholder="Resell / Grosir" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" name ="in_add" class="btn btn-flat btn-success">
