...
<section class="content">
    <div class="row">
        <div class="col-lg-4" style="height: 172px;">
            <div class="box box-widget" style="height: 152px;">
                <div class="box-body">
                    <table width="100%">
                        <tr>
            ...
            <div class="box box-widget" style="height: 152px;">
                <div class="box-body">
                    <table width="100%">
                        <tr>
                            <td style="vertical-align:top; width:30%">
                                <label for="sub_total">Tunai</label>
                            </td>
                            <td>
                                <div class="form-group">
                        ...
                        <tr>
                            <td style="vertical-align:top">
                                <label for="user">Kembalian</label>
                            </td>
                            <td>
                                <div class="form-group">
                ...
                <div class="box-body">
                    ...
                    <div id="delivery" style="display:none;">
                        <table width="100%">
                            <tr>
                                <td style="vertical-align:top;">
                                    <label for="sub_total">No. SIP</label>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" id="no_resep" class="form-control">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align:top;">
                                    <label for="sub_total">Nama Dokter/RS</label>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" id="nama_resep" class="form-control">
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    <button id="cancel_payment" class="btn btn-flat btn-warning">
                                        <i class="fa fa-refresh"></i> &nbspCancel
                                    </button>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <button id="process_payment" class="btn btn-flat btn-success">
                                        <i class="fa fa-paper-plane-o"></i> &nbspBayar&nbsp&nbsp
                                    </button>
                                </td>
                            </tr>                
                        </table>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-tittle">Ubah Item Produk</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="discount_item">Diskon Per-item</label>
            ...
            <div class="modal-footer">
                <div class="pull-right">
                    <button type="button" id="edit_cart" class="btn btn-flat btn-success"><i class="fa fa-check"></i> Simpan</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
            ...
            $.ajax({
                ...
                success: function(result) {
                    if(result.success == true) {
                        ...
                        alert('Gagal tambah item ke keranjang belanja')
                    }
                }
            })
        }
    ...
    $(document).on('click', '#del_cart', function(params) {
        if(confirm('Yakin mau menghapus barang dari keranjang?'))
        {
    ...
    $(document).on('click', '#process_payment', function() {
        ...
        if(subtotal < 1)
        {
            ...
            alert('Uang Tunai belum diinput')
            $('#cash').focus()
        } else {
            if(confirm('Yakin proses transaksi ini')) {
                ...
                ({
                    ...
                    data: {'process_payment': true, 'customer_id': customer_id, 'subtotal': subtotal,
                            ...
                            'resep_id': resep_id, 'resep_name': resep_name,'date': date},
                    dataType: 'json',
                    success: function(result){
                        if(result.success)
                        {
